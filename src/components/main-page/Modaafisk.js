...
class Modaafisk extends React.Component  {
    constructor(props) {
      super(props)
    ...
    render() {
        ...
        const isdisplayable = this.props.modalvisible ? "block" : "none";
  ...
  function mapStateToProps(state) {
    return {
      modalvisible: state.visibles,
      item: state.modalitem
    };
  }

export default connect(mapStateToProps)(Modaafisk)
